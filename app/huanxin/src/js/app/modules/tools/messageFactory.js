...
function _getCustomerImg(msg){
		return profile.CustomerImg
}
function _getAvatar(msg){
	...
	console.log(avatarFromMessageExt)
	var avatar;
...
function genDomFromMsg(msg, isReceived, isHistory){
	...
	if(direction === "left"){
		...
		html += "<img class=\"avatar\" src=\"" +_getCustomerImg() + "\">";
	}
	console.log(_getCustomerImg())
	// wrapper开始

 ...
 * 手写签名公共控制器
 */
app.controller('identitySingatureCtrl', function ($window,fydorderService,$rootScope,$scope,$location,UserInfo,$timeout,WithdrawRecordObject,ngUtils,WithdrawService,$cacheFactory,$routeParams) {	
 ...
 //      $location.url("/helpCenter?xAuthToken="+token);
	...
	$scope.confirm = function(obj){
		...
		WithdrawService.saveIdentitySingature($scope);
	}
	//进行人工审核签字
